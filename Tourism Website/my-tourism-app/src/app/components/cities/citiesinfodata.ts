...
export const Citiesinfo: cityInfo[]= [
    ...
    {name:'Cairo', attractionSites:["The Pyramids","Nile","Khan elKahlili"]},
...
export const citiesWeather =[
    {name:'Aswain', springN: 23, springM:40, summerN:28,summerM:43, winterN:12, winterM:25, autumnN:22,autumnM:36, visitFrom:"October", visitTo:"April"},
    ...
    {name:'Sharm El Sheikh', springN: 21, springM:30, summerN:29,summerM:38, winterN:16, winterM:24, autumnN:20,autumnM:36, visitFrom:"October", visitTo:"November"},
